...
import org.cytoscape.biogwplugin.internal.parser.getSourceGraph
import org.cytoscape.biogwplugin.internal.parser.getUri
import org.cytoscape.biogwplugin.internal.query.BGExpandRelationToNodesQuery
...
class BGExpandEdgeDoubleClickEVTF(val serviceManager: BGServiceManager): EdgeViewTaskFactory {
    override fun createTaskIterator(edgeView: View<CyEdge>?, netView: CyNetworkView?): TaskIterator {
        ...
        val returnType = when (edgeUri == PPI_URI) {
            ...
            true -> BGReturnType.RELATION_TRIPLE
        }
