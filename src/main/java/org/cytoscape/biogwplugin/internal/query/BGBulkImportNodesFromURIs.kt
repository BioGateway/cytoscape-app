...
class BGBulkImportNodesFromURIs(serviceManager: BGServiceManager, val nodeType: BGNodeType, val nodeUris: Collection<String>): BGQuery(serviceManager, BGReturnType.NODE_LIST_DESCRIPTION_TAXON) {
