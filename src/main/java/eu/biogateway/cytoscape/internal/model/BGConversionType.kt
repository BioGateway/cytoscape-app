...
class BGNodeConversionType(val nodeType: BGNodeTypeNew, direction: ConversionDirection, id: String, name: String, dataType: BGTableDataType, biogwId: String, lookupMethod: LookupMethod, template: String? = null, sparqlTemplate: String? = null): BGConversionType(direction, id, name, dataType, biogwId, lookupMethod, template, sparqlTemplate) {
    constructor(nodeType: BGNodeTypeNew, conversionType: BGConversionType) : this(nodeType, conversionType.direction, conversionType.id, conversionType.name, conversionType.dataType, conversionType.biogwId, conversionType.lookupMethod, conversionType.template, conversionType.sparqlTemplate)
}
