...
import eu.biogateway.app.internal.util.SortedComboBoxModel;
...
import static eu.biogateway.app.internal.gui.BGQueryBuilderController.Companion;
...
//            BGTutorial tutorial = new BGTutorial();
    ...
    private void $$$setupUI$$$() {
        ...
        panel2.setBorder(BorderFactory.createTitledBorder(null, "Stored Queries", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        buildQueryPanel.add(scrollPane1, BorderLayout.CENTER);
        final JPanel panel3 = new JPanel();
        panel3.setLayout(new BorderLayout(0, 0));
        scrollPane1.setViewportView(panel3);
        panel3.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Queries", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        multiQueryContainer = new JPanel();
        multiQueryContainer.setLayout(new BorderLayout(0, 0));
        panel3.add(multiQueryContainer, BorderLayout.NORTH);
        ...
        bulkQueryPanel.add(panel4, BorderLayout.SOUTH);
        ...
        bulkQueryPanel.add(panel5, BorderLayout.CENTER);
        ...
        scrollPane2.setViewportView(bulkImportTextPane);
        ...
        panel6.add(bulkSearchResultLabel, BorderLayout.SOUTH);
        ...
        scrollPane3.setViewportView(bulkImportResultTable);
        final JPanel panel8 = new JPanel();
        panel8.setLayout(new BorderLayout(0, 0));
        bulkQueryPanel.add(panel8, BorderLayout.EAST);
        final JPanel panel9 = new JPanel();
        panel9.setLayout(new BorderLayout(0, 0));
        bulkQueryPanel.add(panel9, BorderLayout.NORTH);
        ...
        sparqlPanel.add(scrollPane4, BorderLayout.CENTER);
        sparqlTextArea = new JTextArea();
        scrollPane4.setViewportView(sparqlTextArea);
        ...
        panel14.add(cleanUpSPARQLButton);
        ...
        resultTable = new JTable();
        scrollPane5.setViewportView(resultTable);
